...
export function TermsAndConditions() {
  return (
    <div>
      ...
      <p>
        We are Tawsellah ('<strong>Company</strong>', '<strong>we</strong>', '
        <strong>us</strong>', or '<strong>our</strong>'), a company registered in
        Jordan at alzarqa, __________.
      </p>
      <br />
      <p>
        We operate the website{" "}
        <a
          href="https://tawsellahf.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary hover:underline"
        >
          https://tawsellahf.vercel.app/
        </a>{" "}
        (the '<strong>Site</strong>'), the mobile application Tawsellah (the '
      ...
      <br />
      <p>Tawsellah app is an app for passengers transportation.</p>
      <br />
      <p>
        You can contact us by email at tawsellah2@gmail.com or by mail to
        alzarqa, __________, Jordan.
      </p>
      <br />
      <p>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ('<strong>you</strong>
        '), and Tawsellah, concerning your access to and use of the Services. You
      ...
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li>
          <a href="#mobile" className="text-primary hover:underline">
        ...
        <li>
          <a href="#ppno" className="text-primary hover:underline">
            PRIVACY POLICY
          </a>
        </li>
        <li>
      ...
      <p>
        ...
        address your request to: tawsellah2@gmail.com. If we ever grant you the
      ...
      <h2 id="mobile">
        <strong>8. MOBILE APPLICATION LICENCE</strong>
      </h2>
      <h3>
      ...
      <p>
        ...
        hosted in Jordan. If you access the Services from any other region of
        ...
        Jordan, then through your continued use of the Services, you are
        transferring your data to Jordan, and you expressly consent to have your
        data transferred to and processed in Jordan.
      </p>
      <br />
      ...
      <p>
        ...
        Jordan. Tawsellah and yourself irrevocably consent that the courts of
        Jordan shall have exclusive jurisdiction to resolve any dispute which
      ...
      <p>
        ...
        provided below) informally for at least three hundred sixty five (365)
      ...
      <p>
        ...
        be five (5). The seat, or legal place, or arbitration shall be amman,
        Jordan. The language of the proceedings shall be arabic. The governing
        law of these Legal Terms shall be substantive law of Jordan.
      </p>
      <h3>
...
-venture, partnership, employment or agency relationship created between
      ...
      <br />
      <p>
        <strong>Tawsellah</strong>
      </p>
      <p>
        <strong>alzarqa</strong>
      </p>
      <p>
        <strong>Jordan</strong>
      </p>
      <p>
        <strong>tawsellah2@gmail.com</strong>
      </p>
    </div>
  );
}
